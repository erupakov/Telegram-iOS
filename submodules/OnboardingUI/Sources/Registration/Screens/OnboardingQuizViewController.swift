...
public final class OnboardingQuizViewController: UIViewController {
    ...
    public protocol Delegate: AnyObject {
        ...
        func quizControllerDidTapClose(_ controller: OnboardingQuizViewController)
    }
    ...
    private func setupUI() {
        ...
        NSLayoutConstraint.activate([
            ...
            closeButton.topAnchor.constraint(equalTo: safe.topAnchor, constant: DivoDesignTokens.Spacing.s),
            closeButton.trailingAnchor.constraint(equalTo: view.trailingAnchor, constant: -DivoDesignTokens.Spacing.m),
            ...
            scrollView.bottomAnchor.constraint(equalTo: continueButton.topAnchor, constant: -DivoDesignTokens.Spacing.m),
    ...
    private func applyDescriptor() {
        ...
        closeButton.isHidden = !descriptor.showsCloseButton
        backButton.isHidden = descriptor.showsCloseButton  // на первом экране — только close
    ...
    @objc private func closeTapped() { delegate?.quizControllerDidTapClose(self) }
