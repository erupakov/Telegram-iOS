...
public final class TimeController: ViewController {
    ...
    override public func loadDisplayNode() {
        self.displayNode = TimeControllerNode(context: self.context, presentationData: self.presentationData, mode: self.mode, style: self.style, currentTime: self.currentTime, minimalTime: self.minimalTime, dismissByTapOutside: self.dismissByTapOutside)
