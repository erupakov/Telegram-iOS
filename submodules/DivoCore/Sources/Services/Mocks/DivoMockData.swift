    ...
    static func userDetail(id: Int, useCurrentRole: Bool = true) -> Data {
        ...
        return """
        {
            ...
            "data": {
                ...
                "phone": null,
                "photo": {"fileName": "photo.jpg", "fullUrl": "https://cdn.divo.global/files/CBnhTZrU9jAPFPEPvknoRdgg5ohh17SLRktwSvpR_tempo_v17_1280x2775.jpg", "extension": "jpg", "fileUuid": "mock-photo-\(id)", "photo_id": \(imgId)},
                "avatar": {"fileName": "avatar.jpg", "fullUrl": "https://cdn.divo.global/files/CBnhTZrU9jAPFPEPvknoRdgg5ohh17SLRktwSvpR_tempo_v17_288x288.jpg", "extension": "jpg", "fileUuid": "mock-avatar-\(id)", "photo_id": \(imgId)},
                "role": "\(roleString)",
                "subrole": null,
                "roleLabel": "\(roleLabel)",
