...
public enum DivoStrings {
    ...
    public static var settingsSetUsername: String { L(en: "Name and username", ru: "Имя и никнейм", es: "Nombre y nombre de usuario", pt: "Nome e nome de usuário", zh: "姓名和用户名") }
    public static var usernameSection: String { L(en: "Username", ru: "Никнейм", es: "Nombre de usuario", pt: "Nome de usuário", zh: "用户名") }
    public static var usernamePlaceholder: String { L(en: "username", ru: "никнейм", es: "nombre de usuario", pt: "nome de usuário", zh: "用户名") }
    public static var usernameHint: String { L(en: "Other people will be able to find you by your @username.", ru: "Другие пользователи смогут найти вас по @никнейму.", es: "Otras personas podrán encontrarte por tu @usuario.", pt: "Outras pessoas poderão te encontrar pelo seu @usuário.", zh: "其他人可以通过您的 @用户名 找到您。") }
    public static var usernameAvailable: String { L(en: "Username is available", ru: "Никнейм свободен", es: "El nombre de usuario está disponible", pt: "Nome de usuário disponível", zh: "用户名可用") }
    public static var usernameTaken: String { L(en: "Username is already taken", ru: "Никнейм уже занят", es: "El nombre de usuario ya está en uso", pt: "Nome de usuário já está em uso", zh: "用户名已被占用") }
    public static var usernameInvalid: String { L(en: "Username is not available", ru: "Никнейм недоступен", es: "El nombre de usuario no está disponible", pt: "Nome de usuário indisponível", zh: "用户名不可用") }
    public static var usernameInvalidChars: String { L(en: "Only a–z, 0–9 and underscores", ru: "Только латиница, цифры и _", es: "Solo a–z, 0–9 y guiones bajos", pt: "Apenas a–z, 0–9 e sublinhados", zh: "仅限 a–z、0–9 和下划线") }
    public static var usernameTooShort: String { L(en: "Username is too short", ru: "Никнейм слишком короткий", es: "El nombre de usuario es demasiado corto", pt: "Nome de usuário muito curto", zh: "用户名太短") }
    public static var usernameStartsWithDigit: String { L(en: "Can't start with a digit", ru: "Не может начинаться с цифры", es: "No puede empezar con un dígito", pt: "Não pode começar com um dígito", zh: "不能以数字开头") }
    public static var usernameStartsWithUnderscore: String { L(en: "Can't start with an underscore", ru: "Не может начинаться с _", es: "No puede empezar con un guion bajo", pt: "Não pode começar com sublinhado", zh: "不能以下划线开头") }
    public static var usernameEndsWithUnderscore: String { L(en: "Can't end with an underscore", ru: "Не может заканчиваться на _", es: "No puede terminar con un guion bajo", pt: "Não pode terminar com sublinhado", zh: "不能以下划线结尾") }
    public static var usernameUpdateFailed: String { L(en: "Couldn't update username", ru: "Не удалось обновить никнейм", es: "No se pudo actualizar el nombre de usuario", pt: "Não foi possível atualizar o nome de usuário", zh: "无法更新用户名") }
