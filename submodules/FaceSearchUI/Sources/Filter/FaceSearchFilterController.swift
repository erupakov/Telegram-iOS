    ...
    private func setupAppearanceFilterItems() {
        var items: [AppearanceFilterItem] = [
            ...
            AppearanceFilterItem(
                ...
                emptyTitle: DivoStrings.debugAny,
                onTap: { [weak self] in
                    self?.showRangeFilter(title: DivoStrings.heightCm, kind: .height, keyPath: \.heightRange, min: 140, max: 210)
                }
            ),
            AppearanceFilterItem(
                ...
                emptyTitle: DivoStrings.debugAny,
                onTap: { [weak self] in
                    self?.showRangeFilter(title: DivoStrings.paramWaist, kind: .waist, keyPath: \.waistRange, min: 50, max: 120)
                }
            ),
            AppearanceFilterItem(
                ...
                emptyTitle: DivoStrings.debugAny,
                onTap: { [weak self] in
                    self?.showRangeFilter(title: DivoStrings.paramHips, kind: .hips, keyPath: \.hipsRange, min: 70, max: 140)
                }
            ),
            AppearanceFilterItem(
                ...
                emptyTitle: DivoStrings.debugAny,
                onTap: { [weak self] in
                    self?.showRangeFilter(title: DivoStrings.paramShoeSize, kind: .shoeSize, keyPath: \.shoeSizeRange, min: 34, max: 48)
                }
            )
        ]
